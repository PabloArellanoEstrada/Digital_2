...
# 688 "C:\\Program Files\\Microchip\\xc8\\v2.31\\pic\\sources\\c90\\common\\doprnt.c"
  case 'f':
   flag |= 0x400;
   break;
# 776 "C:\\Program Files\\Microchip\\xc8\\v2.31\\pic\\sources\\c90\\common\\doprnt.c"
dostring:


   if(prec && (prec < ((int)len)))
    len = (unsigned int)prec;
# 793 "C:\\Program Files\\Microchip\\xc8\\v2.31\\pic\\sources\\c90\\common\\doprnt.c"
   while(len--)
    ((*sp++ = (*cp++)));
   ...
   continue;
# 810 "C:\\Program Files\\Microchip\\xc8\\v2.31\\pic\\sources\\c90\\common\\doprnt.c"
  case 'c':
# 825 "C:\\Program Files\\Microchip\\xc8\\v2.31\\pic\\sources\\c90\\common\\doprnt.c"
